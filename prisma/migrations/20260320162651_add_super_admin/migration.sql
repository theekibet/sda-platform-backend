...
INSERT INTO "new_members" ("adminNotes", "age", "avatarUrl", "bio", "createdAt", "email", "gender", "id", "isActive", "isAdmin", "isSuspended", "lastActiveAt", "latitude", "locationLastUpdated", "locationName", "locationPrivacy", "longitude", "name", "password", "phone", "resetToken", "resetTokenExpiry", "suspendedUntil", "suspensionReason", "updatedAt") SELECT "adminNotes", "age", "avatarUrl", "bio", "createdAt", "email", "gender", "id", "isActive", "isAdmin", "isSuspended", "lastActiveAt", "latitude", "locationLastUpdated", "locationName", "locationPrivacy", "longitude", "name", "password", "phone", "resetToken", "resetTokenExpiry", "suspendedUntil", "suspensionReason", "updatedAt" FROM "members";
DROP TABLE "members";
