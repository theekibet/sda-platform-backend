/*
  ...
  - You are about to drop the `group_discussion_replies` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `group_discussions` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `groupReplies` on the `notification_preferences` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "group_discussion_replies_discussionId_idx";

-- DropIndex
DROP INDEX "group_discussions_createdAt_idx";

-- DropIndex
DROP INDEX "group_discussions_groupId_idx";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "group_discussion_replies";
...
CREATE TABLE "group_messages" (
    ...
    CONSTRAINT "group_messages_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "members" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "message_reactions" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "message_reactions_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "group_messages" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "message_reactions_userId_fkey" FOREIGN KEY ("userId") REFERENCES "members" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_notification_preferences" ("announcements", "createdAt", "emailEnabled", "groupInvites", "id", "inAppEnabled", "prayerResponses", "quietHoursEnabled", "quietHoursEnd", "quietHoursStart", "updatedAt", "userId", "versePublished") SELECT "announcements", "createdAt", "emailEnabled", "groupInvites", "id", "inAppEnabled", "prayerResponses", "quietHoursEnabled", "quietHoursEnd", "quietHoursStart", "updatedAt", "userId", "versePublished" FROM "notification_preferences";
