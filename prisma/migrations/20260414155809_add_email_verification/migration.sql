...
INSERT INTO "new_members" ("adminNotes", "age", "avatarUrl", "bio", "createdAt", "dateOfBirth", "email", "gender", "googleId", "id", "isActive", "isModerator", "isSuperAdmin", "isSuspended", "lastActiveAt", "lastUsernameChange", "latitude", "locationLastUpdated", "locationName", "longitude", "name", "password", "phone", "resetToken", "resetTokenExpiry", "suspendedUntil", "suspensionReason", "updatedAt", "username") SELECT "adminNotes", "age", "avatarUrl", "bio", "createdAt", "dateOfBirth", "email", "gender", "googleId", "id", "isActive", "isModerator", "isSuperAdmin", "isSuspended", "lastActiveAt", "lastUsernameChange", "latitude", "locationLastUpdated", "locationName", "longitude", "name", "password", "phone", "resetToken", "resetTokenExpiry", "suspendedUntil", "suspensionReason", "updatedAt", "username" FROM "members";
DROP TABLE "members";
